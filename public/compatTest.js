function compatTest() {
  ...
  document.body.innerHTML = '<table style="width:100%;height:100%;border-collapse:collapse"><tr><td style="vertical-align:middle;text-align:center"><div style="display:inline-block"><img src=./unsupported.png><h3>Your browser is not supported</h3><p>Please, update your browser to use BeHappy.</p><a id="ignore" href="#">I\'m Feeling Lucky</a></div></table>';
