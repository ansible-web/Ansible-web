...
export default {
  ...
  "SentAppCode": "We've sent the code to the **BeHappy** app on your other device.",
  ...
  "LoginQRTitle": "Log in to BeHappy by QR Code",
  "LoginQRHelp1": "Open BeHappy on your phone",
